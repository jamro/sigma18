...
export default class Walkthrough {
  ...
  constructor() {
    ...
    this._validators$$ = [
      ...
      new Validator('door-open-standard', "Explore locations behind closed doors. To open the door, enter the room and run s{com status}s to get ID of doors that you are going to open. Next, run s{door open ID}s."),
      new Validator('item-disk-crew', "Go to office area m{([B:4])}m and search for crew records. It contains important information required in exploration of the space station."),
      ...
      new Validator('door-open-red', "Use red key card to access the service area at the end of northern corridor behind the Lobby m{([D:1])}m"),
      ...
      new Validator('com-lights-east-on', "Turn lights in eastern part of the station by running s{power up lights-east}s. Powering down of some services may be required to have enough power. Check list of services by running s{power list}s and turn selected services off by s{power down X}s."),
      ...
      new Validator('com-pump-station-on', "Turn pump station to fuel rescue capsule by running s{power up pump-station}s. Powering down of some services may be required to have enough power. Check list of services by running s{power list}s and turn selected services off by s{power down X}s."),
